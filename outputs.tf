...
output "opensearch_domains_advanced_security_options" {
  ...
  value       = { for k, v in aws_opensearch_domain.opensearch_domains : k => one(v.advanced_security_options) if v.advanced_security_options != null && length(v.advanced_security_options) > 0 }
  sensitive   = true
}
output "opensearch_domains_aiml_options" {
  ...
  value       = { for k, v in aws_opensearch_domain.opensearch_domains : k => one(v.aiml_options) if v.aiml_options != null && length(v.aiml_options) > 0 }
}
...
output "opensearch_domains_auto_tune_options" {
  ...
  value       = { for k, v in aws_opensearch_domain.opensearch_domains : k => one(v.auto_tune_options) if v.auto_tune_options != null && length(v.auto_tune_options) > 0 }
}
output "opensearch_domains_cluster_config" {
  ...
  value       = { for k, v in aws_opensearch_domain.opensearch_domains : k => one(v.cluster_config) if v.cluster_config != null && length(v.cluster_config) > 0 }
}
output "opensearch_domains_cognito_options" {
  ...
  value       = { for k, v in aws_opensearch_domain.opensearch_domains : k => one(v.cognito_options) if v.cognito_options != null && length(v.cognito_options) > 0 }
}
...
output "opensearch_domains_deployment_strategy_options" {
  ...
  value       = { for k, v in aws_opensearch_domain.opensearch_domains : k => one(v.deployment_strategy_options) if v.deployment_strategy_options != null && length(v.deployment_strategy_options) > 0 }
}
output "opensearch_domains_domain_endpoint_options" {
  ...
  value       = { for k, v in aws_opensearch_domain.opensearch_domains : k => one(v.domain_endpoint_options) if v.domain_endpoint_options != null && length(v.domain_endpoint_options) > 0 }
}
...
output "opensearch_domains_ebs_options" {
  ...
  value       = { for k, v in aws_opensearch_domain.opensearch_domains : k => one(v.ebs_options) if v.ebs_options != null && length(v.ebs_options) > 0 }
}
output "opensearch_domains_encrypt_at_rest" {
  ...
  value       = { for k, v in aws_opensearch_domain.opensearch_domains : k => one(v.encrypt_at_rest) if v.encrypt_at_rest != null && length(v.encrypt_at_rest) > 0 }
}
...
output "opensearch_domains_identity_center_options" {
  ...
  value       = { for k, v in aws_opensearch_domain.opensearch_domains : k => one(v.identity_center_options) if v.identity_center_options != null && length(v.identity_center_options) > 0 }
}
...
output "opensearch_domains_node_to_node_encryption" {
  ...
  value       = { for k, v in aws_opensearch_domain.opensearch_domains : k => one(v.node_to_node_encryption) if v.node_to_node_encryption != null && length(v.node_to_node_encryption) > 0 }
}
output "opensearch_domains_off_peak_window_options" {
  ...
  value       = { for k, v in aws_opensearch_domain.opensearch_domains : k => one(v.off_peak_window_options) if v.off_peak_window_options != null && length(v.off_peak_window_options) > 0 }
}
...
output "opensearch_domains_snapshot_options" {
  ...
  value       = { for k, v in aws_opensearch_domain.opensearch_domains : k => one(v.snapshot_options) if v.snapshot_options != null && length(v.snapshot_options) > 0 }
}
output "opensearch_domains_software_update_options" {
  ...
  value       = { for k, v in aws_opensearch_domain.opensearch_domains : k => one(v.software_update_options) if v.software_update_options != null && length(v.software_update_options) > 0 }
}
...
output "opensearch_domains_vpc_options" {
  ...
  value       = { for k, v in aws_opensearch_domain.opensearch_domains : k => one(v.vpc_options) if v.vpc_options != null && length(v.vpc_options) > 0 }
}
